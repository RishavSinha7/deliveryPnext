...
export function IntercityCourierCards() {
  return (
    <div className="my-16">
      <div className="text-center font-bold text-2xl mb-8">Why is Delivery-Partners your go-to for Intercity Courier Services?</div>
      <div className="text-center text-gray-600 mb-8">
        Your reliable intercity courier partner to ship all your parcels to all over Bihar. Hassle-free & easy to send couriers for all individuals and businesses.
      </div>
      <div className="flex justify-center flex-wrap gap-12">
        <div className="text-center">
          <div className="mb-4 flex justify-center flex-wrap"></div>
